	...
	switch(lang) {
		default: //default to english
			...
			prompts.ic = 'Please read the following document carefully, then '+
				'either select "I don\'t agree" or "I agree"';
...
function informedConsent(){
	...
	uwClause.innerHTML = "<p>"+prompts.uW+"</p><div>No</div>"+
		"<input id='notUW' type='radio' name='test' value='notUW'>"+
		"<div>Yes</div><input id='UW' type='radio' name='test' value='UW'>";
